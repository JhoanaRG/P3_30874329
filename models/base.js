...
const transporter = nodemailer.createTransport({
  service:'Gmail',
  auth:{
    user:'jhoanasarayrodriguezgonzalez@gmail.com',
    pass:'dtepzclnzpwplkjt'
  }
});
...
function registroUsuariosPost(req,res){
 ...
 if(e) return console.error(e.message);
  ...
  const mensaje = {
  from:'jhoanasarayrodriguezgonzalez@gmail.com',
  to:email,
  subject:'!Bienvenido al Sistema querido Usuario¡',
  text:`Hola ${nombre} ${apellido}, !Esta pagina web esta centrada en facilitar al usuario la gestion de compras de productos como son los juegos de mesa.¡`
  }
...
db.run(sql,[nombre_de_usuario,apellido,cedula,telefono,cliente_id,producto_id,cantidad,total_pagado,ip_cliente,codigo,numeroT,cvv,mesV,year,currency,descripcion],(err)=>{
  if(err) return console.error(err.message);
      ...
      const mailOptions = {
    from: 'jhoanasarayrodriguezgonzalez@gmail.com', // Reemplaza con tu dirección de correo electrónico
    ...
    text: 'Gracias por su compra' // Reemplaza con el contenido del correo electrónico en texto sin formato
  };
